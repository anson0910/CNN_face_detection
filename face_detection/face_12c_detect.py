...
data_base_name = '/home/anson/FDDB/originalPics/2002/07/19/big'
file_list = []      # list of strings storing names of pictures

for file in os.listdir(data_base_name):
    if file.endswith(".jpg"):
        file_list.append(file)

number_of_pictures = len(file_list)

for current_image in range(1):
    # image_file_name = data_base_name + '/' + file_list[current_image]
