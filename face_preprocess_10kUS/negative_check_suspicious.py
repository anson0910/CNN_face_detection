...
MODEL_FILE = '/home/anson/caffe-master/models/face_12cAFLW/deploy.prototxt'
PRETRAINED = '/home/anson/caffe-master/models/face_12cAFLW/face_12cAFLW_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
# Set the right path to your model definition file, pretrained model weights,
# and the image you would like to classify.
MODEL_FILE = '/home/anson/caffe-master/models/face_24cAFLW/deploy.prototxt'
PRETRAINED = '/home/anson/caffe-master/models/face_24cAFLW/face_24cAFLW_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
PRETRAINED = '/home/anson/caffe-master/models/face_48_cal/face_48_cal_train_iter_400000.caffemodel'
caffe.set_mode_gpu()
...
def localNMS(rectangles):
    ...
    while cur_rect < number_of_rects - 1:     # start from first element to second last element
        ...
        while rects_to_compare > 0:      # while there is at least one element after current to compare
            if (IoM(result_rectangles[cur_rect], result_rectangles[cur_rect_to_compare]) >= threshold) \
...
data_base_dir = "/home/anson/face_pictures/ILSVRC2014_train_0002"    # file containing pictures
...
for current_image in range(number_of_images):
    ...
    image_file_name = data_base_dir + '/' + image_file_list[current_image]
